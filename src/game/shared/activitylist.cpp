...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_OBJ_ATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_OBJ_ATTACK_DRY );
	REGISTER_SHARED_ACTIVITY( ACT_OBJ_RETRACT );
#endif
...
//HL2MP
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM1_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM1_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM1_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM1_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM1_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM1_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM1_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM1_END );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM1_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM1_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM1_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM1_2 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_GRENADE_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_GRENADE_ITEM1 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM1 );
#endif
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM3_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM3_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM3_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM3_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM3_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM3_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM3_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM3_END );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_GRENADE_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_GRENADE_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM3 );
#endif
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM4_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM4_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM4_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM4_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM4_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM4_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM4_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM4_END );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ITEM4_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ITEM4_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ITEM4_2 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ITEM4_2 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_GRENADE_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_GRENADE_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM4 );
#endif
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_FLINCH_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_FLINCH_ITEM4 );
#endif
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE1_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE1_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE1_ATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE2_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE2_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM3_GRENADE2_ATTACK );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE1_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE1_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE1_ATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE2_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE2_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ITEM4_GRENADE2_ATTACK );
#endif
...
#if defined( PF2 )
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_HANDMOUTH_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_FINGERPOINT_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_FISTPUMP_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_THUMBSUP_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_NODYES_ITEM3 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_NODNO_ITEM3 );

	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_HANDMOUTH_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_FINGERPOINT_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_FISTPUMP_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_THUMBSUP_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_NODYES_ITEM4 );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_VC_NODNO_ITEM4 );
#endif
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_GRENADE1_PRIME );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_GRENADE1_THROW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_GRENADE2_PRIME );
	REGISTER_SHARED_ACTIVITY( ACT_MP_GESTURE_GRENADE2_THROW );
