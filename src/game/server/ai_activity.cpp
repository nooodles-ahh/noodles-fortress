...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_OBJ_ATTACK );
	ADD_ACTIVITY_TO_SR( ACT_OBJ_ATTACK_DRY );
	ADD_ACTIVITY_TO_SR( ACT_OBJ_RETRACT );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM1_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM1_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM1_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM1_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM1_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM1_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM1_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM1_END );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM1_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM1_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM1_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM1_2 );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_GRENADE_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_GRENADE_ITEM1 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM1 );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM3_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM3_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM3_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM3_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM3_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM3_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM3_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM3_END );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_GRENADE_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_GRENADE_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM3 );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM4_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM4_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM4_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM4_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM4_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM4_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM4_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM4_END );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ITEM4_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ITEM4_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ITEM4_2 );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ITEM4_2 );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_GRENADE_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_GRENADE_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_GRENADE_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_GRENADE_ITEM4 );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_FLINCH_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_FLINCH_ITEM4 );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE1_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE1_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE1_ATTACK );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE2_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE2_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM3_GRENADE2_ATTACK );

	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE1_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE1_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE1_ATTACK );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE2_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE2_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ITEM4_GRENADE2_ATTACK );
#endif
...
#if defined( PF2 )
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_HANDMOUTH_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_FINGERPOINT_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_FISTPUMP_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_THUMBSUP_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_NODYES_ITEM3 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_NODNO_ITEM3 );

	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_HANDMOUTH_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_FINGERPOINT_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_FISTPUMP_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_THUMBSUP_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_NODYES_ITEM4 );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_VC_NODNO_ITEM4 );
#endif
...
#ifdef PF2
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_GRENADE1_PRIME );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_GRENADE1_THROW );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_GRENADE2_PRIME );
	ADD_ACTIVITY_TO_SR( ACT_MP_GESTURE_GRENADE2_THROW );
#endif
}
